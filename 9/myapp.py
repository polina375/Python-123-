...
class SimpleHTTPRequestHandler(BaseHTTPRequestHandler):
    ...
    Отвечает за маршрутизацию запросов и формирование
    HTML-ответов с использованием шаблонов Jinja2.
    """
    ...
    def do_GET(self):
        """
                ...
                В зависимости от пути URL выполняет:
                - отображение главной страницы;
                - отображение информации об авторе;
                - вывод списка пользователей;
                - просмотр конкретного пользователя;
                - вывод списка валют;
                - обновление или удаление валют;
                - обработку ошибочных запросов.
                """
